...
export default function CreateRecipeModal({
  ...
  // populate the errors state with the appropriate messages
  function validateInputs() {
    const { name, category, ingredients, instructions } = recipe;

    const newErrors = {
      name: name.length === 0 ? "Recipe name is required" : "",
      category: category === "" ? "Category is required" : "",
      ingredients: ingredients.length === 0 ? "Ingredients are required" : "",
      instructions:
